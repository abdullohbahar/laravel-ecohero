    ...
    <div class="content-wrapper" style="margin-bottom: 10px; margin-top:50px; position: relative;">
        <div class="image">
            <img src="{{ asset('./assets/dist/img/Delive.png') }}" class="img-fluid"
                style="width: 689px; max-width: 100%; height: auto; position: absolute; right: auto; bottom: 0;">
            <img src="{{ asset('./assets/dist/img/Order.png') }}" class="img-fluid"
            ...
            <div class="row"
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget" style="text-align: left;">
                        ...
                        <p style="color: white;">EcoHero Cargo International streamlines and oversees the transportation of
                            your goods.
                            Our expertise lies in organizing various cargo services, spanning air freight, inland
                            transportation,
                            and sea freight, ensuring smooth transit from the point of origin to the final destination.”.
                        </p>
                    </div>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget" style="text-align: left;">
                        ...
                        <p style="color: black;"><a href="https://ecoherocargo.world/services/"
                                style="color: white;">Services</a></p>
                        <p style="color: black;"><a href="https://ecoherocargo.world/about-us/"
                                style="color: white;">About Us</a></p>
                        <p style="color: black;"><a href="https://ecoherocargo.world/blog/"
                                style="color: white;">Blog</a></p>
                        <p style="color: black;"><a href="https://ecoherocargo.world/personal-shopper/"
                                style="color: white;">Personal Shopper</a></p>
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="footer-widget" style="text-align: left;">
                        ...
                        <p style="color: white;">
                            <i class="fas fa-envelope"></i> <a href="#"
                                style="color: white;">cs@ecoherocargo.world</a>
                        </p>
                        <p style="color: white;">
                            <i class="fas fa-clock" style="color: white;"></i> <a href="#"
                                style="color: white;">Office Hour</a>
                        </p>
