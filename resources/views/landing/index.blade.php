...
@section('content')
    ...
    <footer id="newsletter" style="position: relative;">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"
            style="position: absolute; top: 0; left: 0; z-index: 70px;">
            <path fill="#007374" fill-opacity="1"
        ...
        <div class="container" style="margin-top: 100px">
            ...
            <div class="row"
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320"
                        style="position: absolute; top: 0; left: 0; z-index: 70px;">
                        <path fill="#1e8183" fill-opacity="1"
                            d="M0,64L80,80C160,96,320,128,480,128C640,128,800,96,960,85.3C1120,75,1280,85,1360,90.7L1440,96L1440,320L1360,320C1280,320,1120,320,960,320C800,320,640,320,480,320C320,320,160,320,80,320L0,320Z">
                        </path>
                        ...
                        <div class="row"
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="footer-widget" style="text-align: left;">
                                    ...
                                    <p style="color: white;">EcoHero Cargo International streamlines and oversees the
                                        transportation of
                                        your goods.
                                        Our expertise lies in organizing various cargo services, spanning air freight,
                                        inland
                                        transportation,
                                        and sea freight, ensuring smooth transit from the point of origin to the final
                                        destination.”.
                                    </p>
                                </div>

                                <!-- Tambahkan ikon-ikon media sosial di bawah konten "About" -->
                                <div class="elementor-element elementor-element-b66faef elementor-icon-list--layout-inline elementor-align-left elementor-list-item-link-full_width elementor-widget elementor-widget-icon-list"
                                    data-id="b66faef" data-element_type="widget" data-widget_type="icon-list.default">
                                    <div class="elementor-widget-container">
                                        <ul class="elementor-icon-list-items elementor-inline-items">
                                            ...
                                            <a href="https://www.instagram.com/ecoheroworld/" target="_blank"
                                                class="elementor-icon-list-item elementor-inline-item">
                                                <span class="elementor-icon-list-icon">
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="footer-widget"
                                    style="text-align: left; font-family: 'Lato'sans-serif; font-size: 14px;">
                                    <h4 style="color: white;">Navigation</h4>
                                    <br>
                                    <div style="float: left; width: 50%;">
                                        <ul style="list-style-type: none; padding: 0;">
                                            <li><a href="https://ecoherocargo.world/"
                                                    style="color: white; font-weight: bold;">Home</a></li><br>
                                            <li><a href="https://ecoherocargo.world/about-us/"
                                                    style="color: white; font-weight: bold;">About Us</a></li><br>
                                            <li><a href="https://ecoherocargo.world/services/"
                                                    style="color: white; font-weight: bold;">Services</a></li><br>
                                            <li><a href="https://ecoherocargo.world/pricing/"
                                                    style="color: white; font-weight: bold;">Pricing</a></li><br>
                                            <li><a href="https://ecoherocargo.world/tracking/"
                                                    style="color: white; font-weight: bold;">Track your Shipment</a></li>
                                            <br>
                                            <li><a href="https://ecoherocargo.world/get-quote/"
                                                    style="color: white; font-weight: bold;">Get Quote</a></li><br>
                                        </ul>
                                    </div>
                                    <div style="float: right; width: 50%;">
                                        <ul style="list-style-type: none; padding: 0;">
                                            <li><a href="https://ecoherocargo.world/personal-shopper/"
                                                    style="color: white; font-weight: bold;">Personal Shopper</a></li><br>
                                            <li><a href="https://ecoherocargo.world/blog/"
                                                    style="color: white; font-weight: bold;">Blog</a></li><br>
                                            <li><a href="https://ecoherocargo.world/contact-us/"
                                                    style="color: white; font-weight: bold;">Contact</a></li><br>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6">
                                <div class="footer-widget" style="text-align: left;">
                                    ...
                                    <ul class="fa-ul" style="margin-left: 1.65em;">
                                        <li class="mb-3">
                                            <span class="fa-li"><i class="fas fa-map-marker-alt"></i></span><span
                                                class="ms-2">160 ROBINSON ROAD, #14-04, Postal 068914 Singapore</span>
                                        </li>
                                        <li class="mb-3">
                                            <span class="fa-li"><i class="fas fa-phone-alt"></i></span><span
                                                class="ms-2">+65 9242 9770</span>
                                        </li>

                                        <li class="mb-3">
                                            <span class="fa-li"><i class="fas fa-envelope"></i></span><span
                                                class="ms-2">cargo@ecohero.world</span>
                                        </li>
                                    </ul>
                                </div>
                            </div>
    ...
    <style>
        ...
        .footer-widget {
            margin-bottom: 30px;
            /* Menambahkan ruang antara konten "About" dan ikon-ikon */
        }

        /* Gaya CSS untuk ikon-ikon media sosial */
        .elementor-icon-list-items {
            display: flex;
            /* Mengatur tata letak item menjadi flexbox */
            justify-content: flex-start;
            /* Mengatur penyebaran item dari kiri ke kanan */
            align-items: left;
            /* Mengatur penyejajaran item secara vertikal */
            margin-top: 15px;
            /* Menambahkan ruang di atas ikon-ikon */

        }

        .elementor-icon-list-item {
            margin-right: 15px;
            /* Menambahkan ruang antara setiap ikon */
        }
        ...
        .elementor-icon-list-icon svg {
            ...
            /* Mengatur lebar ikon */
            height: 30px;
            /* Mengatur tinggi ikon */
            stroke: none;
            /* Menonaktifkan efek stroke */
        }
        ...
        @media (max-width: 992px) {
            ...
            #news {
                ...
                padding: 1px;
                width: 100%;
                /* Menetapkan lebar footer 100% */
            }

            #newsletter {
                font-size: 16px;
                /* Misalnya, ukuran font 16 piksel */
            }
