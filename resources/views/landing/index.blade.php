...
@section('content')
                    ...
                    <div class="footer-widget" style="text-align: left; font-family: 'Lato'sans-serif; font-size: 14px;">
                        ...
                        <div style="float: left; width: 50%;">
                            <ul style="list-style-type: none; padding: 0;">
                                <li><a href="https://ecoherocargo.world/" style="color: white; font-weight: bold;">Home</a>
                                </li><br>
                                ...
                                <li><a href="https://ecoherocargo.world/tracking/"
                                        style="color: white; font-weight: bold;">Track your Shipment</a></li><br>
                        ...
                        <ul class="fa-ul" style="margin-left: 1.65em;">
                            <li class="mb-3">
                                <span class="fa-li"><i class="fas fa-map-marker-alt"></i></span><span class="ms-2">160
                                    ROBINSON ROAD, #14-04, Postal 068914 Singapore</span>
                            </li>
                            <li class="mb-3">
                                <span class="fa-li"><i class="fas fa-phone-alt"></i></span><span class="ms-2">+65 9242
                                    9770</span>
                            </li>
    ...
    <style>
        ...
        .row {
            display: flex;
            flex-direction: row;
            /* Mengatur konten di dalam row menjadi horizontal */
        ...
        .col-lg-3 {
            margin: 0 1.2cm;
            /* Memberikan jarak 1.10cm ke kiri dan kanan */
        }
